...
const DICT: Record<string, TranslationEntry> = {
  ...
  // ─── Auth / Users ────────────────────────────────────────
  'auth.connexion': { fr: 'Connexion', en: 'Login' },
  'auth.inscription': { fr: 'Créer un compte', en: 'Create Account' },
  'auth.email': { fr: 'Adresse email', en: 'Email address' },
  'auth.motDePasse': { fr: 'Mot de passe', en: 'Password' },
  'auth.confirmerMdp': { fr: 'Confirmer le mot de passe', en: 'Confirm password' },
  'auth.seConnecter': { fr: 'Se connecter', en: 'Sign in' },
  'auth.sInscrire': { fr: 'S\'inscrire', en: 'Sign up' },
  'auth.nom': { fr: 'Nom', en: 'Last name' },
  'auth.prenom': { fr: 'Prénom', en: 'First name' },
  'auth.pasDeCompte': { fr: 'Pas encore de compte ?', en: 'Don\'t have an account?' },
  'auth.dejaCompte': { fr: 'Déjà un compte ?', en: 'Already have an account?' },
  'auth.creerCompte': { fr: 'Créer un compte', en: 'Create account' },
  'auth.mdpOublie': { fr: 'Mot de passe oublié ?', en: 'Forgot password?' },
  'auth.erreurConnexion': { fr: 'Email ou mot de passe incorrect.', en: 'Invalid email or password.' },
  'auth.erreurInscription': { fr: 'Erreur lors de l\'inscription.', en: 'Registration error.' },
  'auth.mdpNonIdentiques': { fr: 'Les mots de passe ne correspondent pas.', en: 'Passwords do not match.' },
  'auth.bienvenue': { fr: 'Bienvenue sur PharmaCare', en: 'Welcome to PharmaCare' },
  'auth.accesBoutique': { fr: 'Accédez à votre compte pour profiter de tous nos services.', en: 'Sign in to your account to access all our services.' },
  'auth.creerCompteDesc': { fr: 'Rejoignez PharmaCare pour une expérience d\'achat personnalisée.', en: 'Join PharmaCare for a personalized shopping experience.' },
  'profil.titre': { fr: 'Mon Profil', en: 'My Profile' },
  'profil.securite': { fr: 'Sécurité', en: 'Security' },
  'profil.ancienMdp': { fr: 'Mot de passe actuel', en: 'Current password' },
  'profil.nouveauMdp': { fr: 'Nouveau mot de passe', en: 'New password' },
  'profil.confirmerMdp': { fr: 'Confirmer le nouveau mot de passe', en: 'Confirm new password' },
  'profil.changerMdp': { fr: 'Changer le mot de passe', en: 'Change password' },
  'profil.sauvegarder': { fr: 'Sauvegarder', en: 'Save' },
  'profil.membreDepuis': { fr: 'Membre depuis', en: 'Member since' },
  'users.titre': { fr: 'Gestion des Utilisateurs', en: 'User Management' },
  'users.rechercher': { fr: 'Rechercher par nom, email...', en: 'Search by name, email...' },
  'users.tousRoles': { fr: 'Tous les rôles', en: 'All roles' },
  'users.admin': { fr: 'Administrateur', en: 'Administrator' },
  'users.utilisateur': { fr: 'Utilisateur', en: 'User' },
  'users.actif': { fr: 'Actif', en: 'Active' },
  'users.inactif': { fr: 'Inactif', en: 'Inactive' },
  'users.aucun': { fr: 'Aucun utilisateur trouvé.', en: 'No users found.' },
  'users.erreurChargement': { fr: 'Erreur lors du chargement des utilisateurs.', en: 'Error loading users.' },
  'breadcrumb.utilisateurs': { fr: 'Utilisateurs', en: 'Users' },
};
